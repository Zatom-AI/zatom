...
#SBATCH --job-name=finetune-sweep-qm9                         # job name
#SBATCH --output=scripts/perlmutter/regular/logs/finetune_sweep_qm9%j.out  # output log file
#SBATCH --error=scripts/perlmutter/regular/logs/finetune_sweep_qm9%j.err   # error log file
