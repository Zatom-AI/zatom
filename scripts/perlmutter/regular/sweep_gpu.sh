...
# Define run details
DEFAULT_SWEEP_ID="1k2b6il4"                   # NOTE: Generate a unique ID for each run by running `wandb sweep configs/sweep/{train,eval}_sweep_{joint,qm9,mp20,qmof150,omol25,geom}.yaml`
