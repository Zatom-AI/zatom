...
#SBATCH --time=00-09:00:00                                    # time limit for the job (up to 2 days: `02-00:00:00`)
...
DEFAULT_RUN_ID="chcwxud9"                 # NOTE: Generate a unique ID for each run using `python scripts/generate_id.py`
DEFAULT_RUN_DATE="2025-11-24_16-00-00"    # NOTE: Set this to the initial date and time of the run for unique identification (e.g., ${now:%Y-%m-%d}_${now:%H-%M-%S})
...
PRETRAINED_CKPT_PATH="logs/train_fm/runs/train_model-zatom_arch-tft_70M_joint_2025-11-22_10-00-00/checkpoints/model-epoch@619-step@307520-val_qm9_posebusters_rate@0.9785-val_mp20_valid_rate@0.8765.ckpt"  # Path at which to find (initial) pretrained model checkpoint
