...
#SBATCH --job-name=eval-sweep-tft-160M-mp20                   # job name
#SBATCH --output=scripts/perlmutter/regular/logs/eval_sweep_tft_160M_mp20%j.out  # output log file
#SBATCH --error=scripts/perlmutter/regular/logs/eval_sweep_tft_160M_mp20%j.err   # error log file
