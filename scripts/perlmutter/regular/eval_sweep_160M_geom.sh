...
#SBATCH --job-name=eval-sweep-160M-geom                       # job name
#SBATCH --output=scripts/perlmutter/regular/logs/eval_sweep_160M_geom%j.out  # output log file
#SBATCH --error=scripts/perlmutter/regular/logs/eval_sweep_160M_geom%j.err   # error log file
