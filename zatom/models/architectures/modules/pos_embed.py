...
class PlatonicAxialRotaryPositionEncoding(nn.Module):
    """Platonic axial rotary positional encoding layer.
    ...
    def __init__(
        ...
        raise NotImplementedError(
            "PlatonicAxialRotaryPositionEncoding is not yet implemented. Please use AxialRotaryPositionEncoding instead."
        )
